 ...
 * @Last Modified time: 2018-11-20 21:24:19
 */
...
export class ListenAjax {
  ...
  listenAjaxEvent() {
    ...
    window.addEventListener('ajaxAbort', function (e) {
      console.log(e.detail, 'ajaxAbort'); // XMLHttpRequest Object
    });

    window.addEventListener('ajaxLoadEnd', function (e) {
      console.log(e.detail, 'ajaxLoadEnd'); // XMLHttpRequest Object
    });
    
    window.addEventListener('ajaxProgress', function (e) {
      console.log(e.detail, 'ajaxProgress'); // XMLHttpRequest Object
    });
